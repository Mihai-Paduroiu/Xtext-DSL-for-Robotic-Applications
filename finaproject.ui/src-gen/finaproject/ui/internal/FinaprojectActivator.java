 ...
 */
package finaproject.ui.internal;
 ...
 * introduced subclass. 
 */
public class FinaprojectActivator extends AbstractUIPlugin {

	public static final String PLUGIN_ID = "finaproject.ui";
	public static final String ORG_XTEXT_EXAMPLE_MYDSL_MYDSL = "org.xtext.example.mydsl.MyDsl";
	
	private static final Logger logger = Logger.getLogger(FinaprojectActivator.class);
	
	private static FinaprojectActivator INSTANCE;
	...
	public static FinaprojectActivator getInstance() {
		return INSTANCE;
	}
